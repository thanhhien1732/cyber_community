...
export default React.memo(ChatUserItem, (previousProps, updatedProps) => {
    return previousProps.stateChat.chatGroupId === updatedProps.stateChat.chatGroupId && previousProps.i === updatedProps.i && _.isEqual(previousProps.dataSendMessage, updatedProps.dataSendMessage);
});
